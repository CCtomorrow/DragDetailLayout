...
import static com.ai.dragdetaillayout.DragDetailLayoutOther.CurrentPageState.BEHIND;
import static com.ai.dragdetaillayout.DragDetailLayoutOther.CurrentPageState.BOTTOM;
import static com.ai.dragdetaillayout.DragDetailLayoutOther.CurrentPageState.TOP;
...
public class DragDetailLayoutOther extends ViewGroup {
    ...
    private void upHandle() {
        ...
        if (mChangeListener != null) {
            mChangeListener.onStatueChanged(new CurrentPageState(mCurrentIndex));
        }
    }
